...
However, my bootcamp required us to use their custom VS Code instance, running in a Docker container. I installed the Vim plugin and slowly began picking up the basic Vim motions, but Neovim had to wait.  
