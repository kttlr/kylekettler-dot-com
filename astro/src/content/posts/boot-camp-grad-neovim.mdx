...
My config continues to evolve as I learn more about Neovim and I am able to more interesting things with my setup. For instance, I recently added some custom Treesitter queries to improve the syntax highlighting on `.mdx` files. And I know I am still just scratching the surface what is possible in Neovim. You can look at my config, along with other dotfiles for my primary tools, on my <InlineLink to="https://github.com/kyle-kettler/dotfiles" blank={true}>GitHub</InlineLink>. Below is a screenshot of my current config with a TypeScript file open.
