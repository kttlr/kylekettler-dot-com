...
If you're interested in learning more about how I built this site, the entire source code is available on my <InlineLink to="https://github.com/kyle-kettler/kylekettler-dot-com" blank={true}>GitHub</InlineLink>.
